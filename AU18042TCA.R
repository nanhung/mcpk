...
for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,j1.1], xlab = "Time (Hr)", ylab = "",
         main = "M-Liver TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 1.5), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,j1.1], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 1.5)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,2], col = "red" , pch = 20)

for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,k1.1], xlab = "Time (Hr)", ylab = "",
         main = "M-Kidney TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 3), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,k1.1], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 3)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,3], col = "red" , pch = 20)
...
points(AU18042.df[,1], AU18042.df[,4], col = "red" , pch = 20)

for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,m1.1], xlab = "Time (Hr)", ylab = "",
         main = "M-Serum TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 1.5), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,m1.1], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 1.5)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,5], col = "red" , pch = 20)

for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,j1.2], xlab = "Time (Hr)", ylab = "",
         main = "F-Liver TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 1.5), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,j1.2], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 1.5)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,6], col = "red" , pch = 20)

for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,k1.2], xlab = "Time (Hr)", ylab = "",
         main = "F-Kidney TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 3), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,k1.2], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 3)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,7], col = "red" , pch = 20)
...
for (i in 1:dim(TCA.df)[1]) {
  if (i == 1) {
    plot(time, TCA.df[i,m1.2], xlab = "Time (Hr)", ylab = "",
         main = "F-Serum TCA (mmol/l)", las = 1, col = "grey", pch = 20, cex.lab = 1.2,
         type = "b", ylim = c(0, 1.5), cex.main = 1.2)
  } else {
    plot(time, TCA.df[i,m1.2], xlab = "", ylab = "", xaxt = "n", yaxt = "n",
         main = "", las = 1, col = "grey", pch = 20,
         type = "b", ylim = c(0, 1.5)) 
  }
  par(new=T)
}
points(AU18042.df[,1], AU18042.df[,9], col = "red" , pch = 20)
dev.off()